...
if __name__ == "__main__":
    src_path = "./dataset/VOC_N/"
    dst_path = "./dataset/train/voc_trainN.h5"

    os.makedirs(src_path, exist_ok=True)
    os.makedirs(os.path.dirname(dst_path), exist_ok=True)

    src_files = glob.glob(os.path.join(src_path, "*.JPG")) + glob.glob(os.path.join(src_path , "*.jpg"))
    print("start noisy set...")
    gen_dataset(src_files, dst_path)
    print('end noisy set...')

    src_path = "./dataset/VOC_C/"
    dst_path = "./dataset/train/voc_trainC.h5"
